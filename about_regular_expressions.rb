...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # THINK ABOUT IT:
    #
    # When would * fail to match? empty string ? nevaaa
  end
  ...
  #
  # Why? They match the longest posssible string.
  ...
  #([...]) is faster in matching set of characters (|) is better for varing lengths i guess 
