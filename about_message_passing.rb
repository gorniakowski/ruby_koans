...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # THINK ABOUT IT:
    #
    # Why does Ruby provide both send and __send__ ? sometimes you can overwrite send method
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # what would happen if we redefine method_missing? method_missing would work as defined.
    #
    # NOTE:
    #
