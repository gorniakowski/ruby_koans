...
class AboutSymbols < Neo::Koan
  ...
  # against the string value rather than against symbols?  :test == "test" would be false because
  # we compare object_id not the values
  ...
  # It uses a lot of memory and since symbols are immutable memory cannot be freed.
end
